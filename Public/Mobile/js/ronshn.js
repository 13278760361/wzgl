...
$(document).ready(function(){
    var a=['.lists tr','.lists td','[poster]','[geter]','[uploader]','[clicker]','[selectfile]','.poster','.geter','table [order]'];
...
//跳转链接
$(".lists").delegate("td",'click',function(){
...
//实例化layer
function _layer(){return window.top==window.self?layer:parent.layer;}
//layer.open
function opener(s)
{
