...
(function($){
	...
	$.showCategorySelecter = function(catNameObj, catIdObj, zNodes, selectedId, lang_cat_expand_all, lang_cat_collect_all, lang_cat_expand, lang_cat_collect)
	{
		...
		//生成DIV
		var menuHtml = "<div id='"+menuContent_id+"' class='menuContent' style='display: none; position: absolute; background-color: white; border: 1px #999 solid; height:360px; overflow:scroll'>"
		    ...
		    // +"</div>"
		    +"<ul id='"+treeDemo_id+"' class='ztree' style='margin-top:0; width:206px; height: auto; overflow: auto;'></ul>"
		    +"</div>";
	 ...
	 * @param lang_cat_collect 收缩的语言项设置
	 */
	$.ajaxCategorySelecter = function(url,catNameObj, catIdObj, selectedId, lang_cat_expand_all, lang_cat_collect_all, lang_cat_expand, lang_cat_collect){
	...
	$.ajaxCategorySelecterPost = function(url,catNameObj, catIdObj, selectedId, postdata, lang_cat_expand_all, lang_cat_collect_all, lang_cat_expand, lang_cat_collect){
